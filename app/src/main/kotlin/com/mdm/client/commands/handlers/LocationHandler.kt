        ...
        return runBlocking(Dispatchers.IO) {
            try {
                ...
                if (!gpsEnabled && !netEnabled) {
                    return@runBlocking ExecutionResult.failure("GPS y red de localización deshabilitados.")
                }
                ...
                if (lastLocation != null && 
                    ...
                    MdmLog.i(TAG, "Usando lastLocation: ${lastLocation.latitude},${lastLocation.longitude}")
                ...
                val freshLocation = withTimeoutOrNull(TimeUnit.SECONDS.toMillis(timeoutSeconds.toLong())) {
            ...
            val callback = object : LocationCallback() {
                override fun onLocationResult(result: LocationResult) {
                    result.lastLocation?.let { location ->
                        MdmLog.i(TAG, "Fresh location recibida: ${location.latitude},${location.longitude}")
