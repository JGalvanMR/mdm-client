...
object CommandType {
    ...
    val ALL = setOf(
        ...
        INSTALL_APP, UNINSTALL_APP, LIST_APPS,
        ENABLE_WIFI, DISABLE_WIFI, SET_WIFI_CONFIG,
        CLEAR_APP_DATA, GET_LOCATION, SET_VOLUME,
        ENABLE_BLUETOOTH, DISABLE_BLUETOOTH, SET_BRIGHTNESS, SEND_MESSAGE
    )
